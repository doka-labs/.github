...
pub struct ProfileConfig {
    /// Public GitHub account responsible for the organization.
    pub maintainer_username: String,
    /// Approved public responsibility label.
...
pub struct CollectionConfig {
    /// Optional personal collection account; empty disables all user-only requests.
    #[serde(default)]
