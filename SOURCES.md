...
Organization project descriptions and maintainer attribution are owner-provided facts.
...
Organization-specific contracts checked September 6, 2026:
...
- [Organization metadata API](https://docs.github.com/en/rest/orgs/orgs#get-an-organization)
